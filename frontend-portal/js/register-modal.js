...
function createRegisterModal() {
  ...
  ModalManager.setup(registerModal, closeRegisterModal);
  ...
  passwordToggleConfirm.addEventListener("click", () =>
    toggleVisibility(passwordConfirmInput, passwordToggleConfirm),
  );
...
export function openRegisterModal() {
  createRegisterModal();
  ModalManager.open(registerModal, "active", "#register-username");
}

export function closeRegisterModal() {
  if (!registerModal) return;
  ModalManager.close(registerModal, "active");
...
function validateRegisterUsername(input) {
  ...
  return validateUsername(input, errorDiv);
}
...
function validateRegisterPassword(input) {
  ...
  return validatePassword(input, errorDiv, strengthBars);
}
...
function validatePasswordMatch(passwordInput, confirmInput) {
  ...
  if (password !== confirm) {
    showError(confirmInput, errorDiv, "Passwords do not match");
    return false;
  }
